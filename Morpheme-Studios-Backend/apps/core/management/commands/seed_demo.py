...
from apps.core.models import Project, ProjectCategory
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            admin.save()
            self.stdout.write(
                self.style.WARNING("Created admin@morphemestudios.com / ChangeMe!2026")
            )
        ...
        cat, _ = BlogCategory.objects.get_or_create(
            slug="insights", defaults={"label": "Insights"}
        )
        ...
        for i, name in enumerate(
            ["Studio Principal", "Design Director", "Project Architect"]
        ):
        ...
        Testimonial.objects.update_or_create(
            ...
            defaults={
                ...
                "quote": "An exceptional studio to work with.",
                "rating": 5,
                "status": PublishStatus.PUBLISHED,
                "published_at": now,
            },
        ...
        SiteSetting.objects.update_or_create(
            ...
            defaults={
                "value": {
                    "text": "Architecture & design that negotiates density with generosity."
                }
            },
        )
